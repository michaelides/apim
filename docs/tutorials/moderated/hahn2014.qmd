...
[indistinguishable tutorial](../indistinguishable/mlm.qmd).
...
- The [exercises section](../../exercises/index.qmd) has a
  nine-section problem set on a separate dataset with three
  outcomes and three moderators.
- The [k-patterns page](../../foundations/kpatterns.qmd) explains
