...
**Reference:** [Hahn et al. (2014) replication tutorial](../../tutorials/moderated/hahn2014.html).
...
**Tutorial reference:** [Hahn et al. (2014) tutorial](../../tutorials/moderated/hahn2014.html). The MLM moderation is in "MLM specification"; the SEM moderation is in "SEM specification (wide format)"; the comparison is in "Compare MLM and SEM".
