...
**Reference:** [Indistinguishable dyads: SEM tutorial](../../tutorials/indistinguishable/sem.qmd).
...
**Tutorial reference:** [Indistinguishable SEM](../../tutorials/indistinguishable/sem.qmd). Models A, B, and C are demonstrated in steps 1–3; the LRT is in the [SEM wide tutorial, Step "Test the equality constraint"](../../tutorials/distinguishable/sem-wide.qmd#the-three-nested-lrts).
