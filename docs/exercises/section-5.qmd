...
**Reference:** [Distinguishable dyads: SEM with moderation tutorial](../../tutorials/distinguishable/sem-moderation.html).
...
**Tutorial reference:** [SEM with moderation](../../tutorials/distinguishable/sem-moderation.html). The interaction-column construction is in the Setup block; the model is in step 2; the simple-slope definitions are in step 3.
